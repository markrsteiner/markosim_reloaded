...
def build__output_view_dict(system, inside_module, outside_module=None, diode_module=None):
    ...
    if is_three_level:
        return {
            ...
            'fc [kHz]': system.get__input_freq_carrier(),
            'fo [Hz]': system.get__input_output_freq(),
            'Ts [\u00B0C]': system.get__input_t_sink(),

            'P Cond. IGBT Outside [W]': outside_module.get__conduction_loss_igbt(),
            'Psw,on IGBT Outside [W]': outside_module.get__esw_on_loss_total(),
            'Psw,off IGBT Outside [W]': outside_module.get__esw_off_loss_total(),
            'Psw IGBT Outside [W]': outside_module.get__esw_loss_total(),
            'P Total IGBT Outside [W]': outside_module.get__igbt_loss_total(),

            'P Cond FWD Outside [W]': outside_module.get__conduction_loss_fwd(),
            'Prr FWD Outside [W]': outside_module.get__err_loss_total(),
            'P Total FWD Outside [W]': outside_module.get__fwd_loss_total(),

            'P Cond. IGBT Inside [W]': inside_module.get__conduction_loss_igbt(),
            'Psw,on IGBT Inside [W]': inside_module.get__esw_on_loss_total(),
            'Psw,off IGBT Inside [W]': inside_module.get__esw_off_loss_total(),
            'Psw IGBT Inside [W]': inside_module.get__esw_loss_total(),
            'P Total IGBT Inside [W]': inside_module.get__igbt_loss_total(),

            'P Cond FWD Inside [W]': inside_module.get__conduction_loss_fwd(),
            'Prr FWD Inside [W]': inside_module.get__err_loss_total(),
            'P Total FWD Inside [W]': inside_module.get__fwd_loss_total(),

            'P Cond FWD Diode [W]': diode_module.get__conduction_loss_fwd(),
            'Prr FWD Diode [W]': diode_module.get__err_loss_total(),
            'P Total FWD Diode [W]': diode_module.get__fwd_loss_total(),

            'P Total Outside [W]': outside_module.get__module_loss_total() * 2,
            'P Total Inside [W]': inside_module.get__module_loss_total() * 2,
            'P Total Diode [W]': diode_module.get__module_loss_total() * 2,

            'ΔT\u2C7C Ave IGBT Outside [K]': outside_module.get__delta_tj_ave_igbt(),
            'ΔT\u2C7C Ave FWD Outside [K]': outside_module.get__delta_tj_ave_fwd(),
            'ΔT\u2C7C Ave IGBT Inside [K]': inside_module.get__delta_tj_ave_igbt(),
            'ΔT\u2C7C Ave FWD Inside [K]': inside_module.get__delta_tj_ave_fwd(),
            'ΔT\u2C7C Ave FWD Diode [K]': diode_module.get__delta_tj_ave_fwd(),

            # Not actually delta_tc, change name - input_tc should be input_ts and this should be nominal tc
            'Tcase Ave. Outside [\u00B0C]': outside_module.get__t_case_ave() + system.get__input_t_sink(),
            'Tcase Ave. Inside [\u00B0C]': inside_module.get__t_case_ave() + system.get__input_t_sink(),
            'Tcase Ave. Diode [\u00B0C]': diode_module.get__t_case_ave() + system.get__input_t_sink(),

            'T\u2C7C Ave IGBT Outside [\u00B0C]': outside_module.get__nom_tj_ave_igbt(),
            'T\u2C7C Ave FWD Outside [\u00B0C]': outside_module.get__nom_tj_ave_fwd(),
            'T\u2C7C Ave IGBT Inside [\u00B0C]': inside_module.get__nom_tj_ave_igbt(),
            'T\u2C7C Ave FWD Inside [\u00B0C]': inside_module.get__nom_tj_ave_fwd(),
            'T\u2C7C Ave FWD Diode [\u00B0C]': diode_module.get__nom_tj_ave_fwd(),

            'ΔT\u2C7C Max IGBT Outside [K]': outside_module.get__delta_tj_max_igbt(),
            'ΔT\u2C7C Max FWD Outside [K]': outside_module.get__delta_tj_max_fwd(),
            'ΔT\u2C7C Max IGBT Inside [K]': inside_module.get__delta_tj_max_igbt(),
            'ΔT\u2C7C Max FWD Inside [K]': inside_module.get__delta_tj_max_fwd(),
            'ΔT\u2C7C Max FWD Diode [K]': diode_module.get__delta_tj_max_fwd(),

            'T\u2C7C Max IGBT Outside [\u00B0C]': outside_module.get__nom_tj_max_igbt(),
            'T\u2C7C Max FWD Outside [\u00B0C]': outside_module.get__nom_tj_max_fwd(),
            'T\u2C7C Max IGBT Inside [\u00B0C]': inside_module.get__nom_tj_max_igbt(),
        ...
        return {
            'P Total IGBT [W]': inside_module.get__igbt_loss_total(),
            'P Cond IGBT [W]': inside_module.get__conduction_loss_igbt(),
            'Psw IGBT [W]': inside_module.get__esw_loss_total(),
            'Psw,on IGBT [W]': inside_module.get__esw_on_loss_total(),
            'Psw,off IGBT [W]': inside_module.get__esw_off_loss_total(),
            'ΔT\u2C7C ave. IGBT [K]': inside_module.get__delta_tj_ave_igbt(),
            'T\u2C7C ave. IGBT [\u00B0C]': inside_module.get__nom_tj_ave_igbt(),
            'ΔT\u2C7C Max_IGBT [K]': inside_module.get__delta_tj_max_igbt(),
            'T\u2C7C Max IGBT [\u00B0C]': inside_module.get__nom_tj_max_igbt(),
            'Tcase Ave. [\u00B0C]': inside_module.get__t_case_ave() + system.get__input_t_sink(),
            'P Total FWD [W]': inside_module.get__fwd_loss_total(),
            'P Cond FWD [W]': inside_module.get__conduction_loss_fwd(),
            'Prr FWD [W]': inside_module.get__err_loss_total(),
            'ΔT\u2C7C Ave FWD [K]': inside_module.get__delta_tj_ave_fwd(),
            'T\u2C7C Ave FWD [\u00B0C]': inside_module.get__nom_tj_ave_fwd(),
            'ΔT\u2C7C Max FWD [K]': inside_module.get__delta_tj_max_fwd(),
            'T\u2C7C Max FWD [\u00B0C]': inside_module.get__nom_tj_max_fwd(),
            'P Arm [W]': inside_module.get__module_loss_total(),
            'Vcc [V]': system.get__input_bus_voltage(),
            'Io [Apk]': system.get__input_current(),
            'PF [cos(\u03D5)]': system.get__input_power_factor(),
            'Mod. Depth': system.get__input_mod_depth(),
            ...
            'fo [Hz]': system.get__input_output_freq(),
            'Ts [\u00B0C]': system.get__input_t_sink(),
            'Module Name': inside_module.get__module_name()
        }
